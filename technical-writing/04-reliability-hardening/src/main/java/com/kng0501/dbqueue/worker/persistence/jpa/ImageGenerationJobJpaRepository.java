package com.kng0501.dbqueue.worker.persistence.jpa;
...
public interface ImageGenerationJobJpaRepository extends JpaRepository<ImageGenerationJobEntity, Long> {
    ...
    @Query("select job.monsterId from ImageGenerationJobEntity job where job.id = :jobId")
