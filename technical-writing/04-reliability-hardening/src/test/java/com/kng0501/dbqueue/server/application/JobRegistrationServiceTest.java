...
final class JobRegistrationServiceTest {
    ...
    void Job_저장이_실패하면_Monster도_롤백한다() {
        ...
        assertThrows(DataAccessException.class, () -> registrationService.request("enqueue-fail"));
    ...
    void Monster_저장이_실패하면_Job도_저장하지_않는다() {
        ...
        assertThrows(DataAccessException.class, () -> registrationService.request("save-fail"));
